...
function averageWordLength(wordsList) { 
  let phrase = 0;
    for (let i=0; i<wordsList.length; i++) {
      phrase += wordsList [i].length;
    } return phrase/wordsList.length;
...
let count = 0;
array.forEach((v) => (v === value && count++)) || null;
    return count;


}
console.log(getOccurrence(arr, 'machine'));  
console.log(getOccurrence(arr, 'matter')); 
